...
var minNumberOfHours = function(initialEnergy, initialExperience, energy, experience) {
  ...
  var currentExpr = initialExperience
  for(let i=0;i<experience.length;i++){
    if(currentExpr<=experience[i]){
      res+=experience[i]-currentExpr+1
      currentExpr+=experience[i]-currentExpr+1
    }
    currentExpr+=experience[i]
  }
